                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="origenProveedor" id="nacionalRadio" value="nacional">
                                        Nacional
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="origenProveedor" id="extranjeroRadio" value="extranjero">
                                        Extranjero
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-8 d-flex justify-content-center align-items-center">
                            <object data="{{ asset('manual.pdf')}}" type="application/pdf" width="100%" height="500px">
                                <p>Tu navegador no puede mostrar el PDF. Puedes <a href="{{ asset('manual.pdf')}}">descargarlo aquí</a>.</p>
                            </object>
                        </div>
                    </div>
                    <div class="row justify-content-center">
