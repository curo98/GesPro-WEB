...
Route::get('/user/{id}', [App\Http\Controllers\Api\SupplierController::class, 'show']);
Route::get('/user/{id}/edit', [App\Http\Controllers\Api\SupplierController::class, 'editUser']);
Route::post('/user/{id}/update', [App\Http\Controllers\Api\SupplierController::class, 'updateUser']);
